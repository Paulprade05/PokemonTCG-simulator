        ...
        >
          ...
          {hasHoloEffect && (
            <div 
                ...
                className="absolute inset-0 z-20 opacity-0 group-hover:opacity-60 transition-opacity duration-500 bg-linear-to-tr from-transparent via-white/30 to-transparent bg-size-[200%_200%] bg-center mix-blend-color-dodge pointer-events-none"
                // Un estilo inline para un gradiente de arcoíris más complejo (opcional, el de Tailwind arriba es más sutil)
                style={{
